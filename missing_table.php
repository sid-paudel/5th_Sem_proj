...
<h2 style="margin-left:120px;">Details of Missing body</h2>
    <div class="container">
      ...
      <tr>
        ...
        <td ><a class='btn btn-info btn-xs' href="edit_missing.php?id=<?php echo $tbl_miss['id'] ?>" onclick="return confirm('are you sure?')"> Edit</a> <a href="dlt.php?id=<?php echo $tbl_miss['id'] ?>" onclick="return confirm('are you sure?')" class="btn btn-danger btn-xs"> Del</a></td>    
          </tr>
    <?php }
   mysqli_close($conn);
     ?>
