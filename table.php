...
<h2 style="margin-left:120px;">Details of unknown body</h2>
    <div class="container">
      ...
      <tr>
        ...
        <td ><a class='btn btn-info btn-xs' href="edit_deadbody.php?id=<?php echo $persons['id'] ?>" onclick="return confirm('are you sure?')"> Edit</a> <a href="delete.php?id=<?php echo $persons['id']; ?>" onclick="return confirm('are you sure?')" class="btn btn-danger btn-xs"> Del</a></td>    
    <?php }
     ?>
                
        </table>
        </div>
        <a href="registration.php" class="btn btn-primary btn-xs pull-right"><b>+</b> Add new Data</a>
    </div>
